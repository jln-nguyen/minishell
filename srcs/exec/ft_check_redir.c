...
/*   Updated: 2025/02/02 13:29:04 by bvkm             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_dup_out(int file_out, int old_out, int old_in, t_data *data)
{
	if (file_out > 0)
	{
	...
	{
		ft_reset_fd(old_in, old_out, data);
		return (-1);
	}
	return (old_out);
}

static void	fd_dup(int file_in, int old_fd_in, t_data *data)
{
	if (file_in > 0)
	{
